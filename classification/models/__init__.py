...
def build_vmamba_old():
    model_params = {
        ...
        'ssm_ratio': 2.0,
        'ssm_dt_rank': 'auto',
        'ssm_act_layer': 'silu',  # Ensure this string maps correctly to an activation function in the _ACTLAYERS dictionary
        'ssm_conv': 3,
        'ssm_conv_bias': True,
        'ssm_drop_rate': 0.0,
        'ssm_init': 'v0',
        'forward_type': 'v0',
        #change fwd type and downsample version to v0 and v1
        'mlp_ratio': 4.0,
        'mlp_act_layer': 'gelu',  # Ensure this string maps correctly to an activation function in the _ACTLAYERS dictionary
        'mlp_drop_rate': 0.0,
        'gmlp': False,
        'drop_path_rate': 0.1,
        'patch_norm': True,
        'norm_layer': 'LN',  # 'BN', 'LN2D' are alternatives; ensure the string maps to a valid norm layer
        'downsample_version': 'v1',  # Options: 'v1', 'v2', 'v3'
        'patchembed_version': 'v1',  # Options: 'v1', 'v2'
        'use_checkpoint': False,
        'posembed': False,
        'imgsize': 224
    }

    vssm_model = VSSM(**model_params)
...
#MODEL:vmambav2v_base_224
#  TYPE: vssm
#  NAME: vssm1_base_0229s
#  DROP_PATH_RATE: 0.6
#  VSSM:
#    EMBED_DIM: 128
#    DEPTHS: [ 2, 2, 20, 2 ]
...
def build_vmamba():
    model_params = {
        ...
        'drop_path_rate': 0.6,
        'patch_norm': True,
        'norm_layer': 'LN2D',  # 'BN', 'LN2D' are alternatives; ensure the string maps to a valid norm layer
        'downsample_version': 'v3',  # Options: 'v1', 'v2', 'v3'
        'patchembed_version': 'v2',  # Options: 'v1', 'v2'
        'use_checkpoint': False,
        'posembed': False,
        'imgsize': 512
    }
...
# from the following file path: classification/configs/wasted/vssm1/vssm_base_224.yaml
